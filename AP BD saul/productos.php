    ...
    <table class="table">
        ...
        <?php
          ...
          <tr>
            ...
            <!-- BOTON DE ELIMINAR -->
            <td>
              <a target="_self" href="acciones/eliminarProductos.php?id=<?php echo $fila["codigo"] ?>"< class="bi bi-trash3-fill text-danger">Eliminar</i>
            </td>
            <td>
            <a target="_blank" href="acciones/edicionProductos.php?id=<?php echo $fila["codigo"] ?>">
