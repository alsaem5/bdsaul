    ...
    <table class="table">
        ...
        <?php
          ...
          <tr>
            ...
            <!--Boton borrar-->
            <td> 
            <a target="_self" href="acciones/eliminarfabricante.php?id=<?php 
            echo $fila["codigo"]?>" target="_self"><i class="bi bi-trash text-danger">Eliminar</i><a/>
            <!--Boton editar-->
            <td><a target="_self" href="acciones/edicionFabricante.php?id=<?php echo $fila["codigo"]?>">
            <i class="bi bi-pencil-square text-primary"></i></td>
            </td>
